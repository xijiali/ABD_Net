...
def argument_parser():
    ...
    parser.add_argument('--stepsize', default=[30, 40],  type=int,
    ...
    parser.add_argument('--htri-only', default=False,
    ...
    parser.add_argument('--save-dir', type=str, default='./ABD_market_again',
