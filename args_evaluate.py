...
def argument_parser():
    ...
    # Datasets (general)
    # ************************************************************
    parser.add_argument('--root', type=str, default='/gruntdata/xiaoxi.xjl/re_id_datasets',
                        help="root path to data directory")
    parser.add_argument('-s', '--source-names', type=str, default=['market1501'],
                        help="source datasets (delimited by space)")
    parser.add_argument('-t', '--target-names', type=str, default=['market1501'],
    ...
    parser.add_argument('--data-augment', type=str, default='crop,random-erase', choices=['none', 'crop', 'random-erase', 'color-jitter', 'crop,random-erase', 'crop,color-jitter', 'crop,color-jitter,random-erase'])
    # ************************************************************
    # Video datasets
    # ************************************************************
    ...
    parser.add_argument('--stepsize', default=[20, 40],  type=int,
    ...
    parser.add_argument('--criterion', default='htri')
    ...
    # ************************************************************
    parser.add_argument('--label-smooth', default=True,
    ...
    # Test settings
    # ************************************************************
    parser.add_argument('--load-weights', type=str, default='/gruntdata/xiaoxi.xjl/my_code/ABD_Net/ABD_market/checkpoint_ep73.pth.tar',
    ...
    parser.add_argument('--start-eval', type=int, default=1,
                        help="start to evaluate after a specific epoch")
    parser.add_argument('--flip-eval', default=True)
    ...
    parser.add_argument('--save-dir', type=str, default='./ABD_market_evaluate',
    ...
    parser.add_argument('--branches', type=str, default=['global', 'abd'])
    ...
    parser.add_argument('--abd-np', type=int, default=3)
    parser.add_argument('--abd-dan', type=str, default=['cam','pam'])
    parser.add_argument('--abd-dan-no-head', action='store_true')
    parser.add_argument('--shallow-cam', default=True)
    ...
    parser.add_argument('--dan-dan', type=str, default=[])
    parser.add_argument('--dan-dan-no-head', action='store_true')

    parser.add_argument('--use-of', default=True)
    parser.add_argument('--of-beta', type=float, default=1e-6)
    parser.add_argument('--of-start-epoch', type=int, default=23)
    parser.add_argument('--of-position',  type=str, default=['before', 'after', 'cam', 'pam', 'intermediate'])

    parser.add_argument('--use-ow', default=True)
