...
from args_evaluate import argument_parser, image_dataset_kwargs, optimizer_kwargs
...
def main():
    ...
    if args.load_weights and check_isfile(args.load_weights):
        ...
        for k, v in pretrain_dict.items():
            ...
            if (args.load_weights.startswith('duke') or args.load_weights.startswith('msmt17')) and (
                    k.startswith('branches.1.1.cam_module') or k.startswith('branches.1.1.pam_module')):
